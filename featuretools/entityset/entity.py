...
class Entity(object):
    ...
    def convert_variable_type(self, variable_id, new_type,
        ...
        if convert_data:
            ...
            convert_variable_data(self, variable_id, new_type, **kwargs)
    ...
    def _create_variables(self, variable_types, index, time_index, secondary_time_index):
        ...
        inferred_variable_types = infer_variable_types(self, variable_types,
                                                       time_index,
        ...
        convert_all_variable_data(self, inferred_variable_types)
