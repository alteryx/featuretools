...
for entry_point in pkg_resources.iter_entry_points(
    ...
    for primitive in loaded:
        ...
        if (
            ...
            and issubclass(primitive, (AggregationPrimitive, TransformPrimitive))
            and primitive is not AggregationPrimitive  # noqa: F405
            and primitive is not TransformPrimitive  # noqa: F405  # noqa: F405
        ):
