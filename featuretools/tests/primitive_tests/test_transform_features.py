...
def test_comparisons_with_ordinal(es):
    ...
    # because Woodowork has not yet been initialized. This calculation should work and return valid True/False
    # values. This should be fixed in a future PRe, but until a fix is implemented null values are returned to
