...
def infer_variable_types(entity, variable_types, time_index, secondary_time_index):
...
def convert_all_variable_data(entity, variable_types):
...
def convert_variable_data(entity, column_id, new_type, **kwargs):
    """
