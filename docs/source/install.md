...
Featuretools is available for Python 3.8 - 3.11
It can be installed from [PyPI](https://pypi.org/project/featuretools/), [conda-forge](https://anaconda.org/conda-forge/featuretools), or from [source](https://github.com/alteryx/featuretools).
