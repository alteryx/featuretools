...
.. glossary::
    ...
    feature
        A transformation of data used for machine learning.  Featuretools has a custom language for defining features as described :doc:`here </getting_started/primitives>`. All features are represented by subclasses of :class:`FeatureBase`.
