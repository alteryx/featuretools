...
**Future Release**
    ...
    * Fixes
        ...
        * Use consistent naming between Feature.get_name() and Feature.get_names() for features with a single output (:pr:`934`)
    ...
    * Testing Changes
    ...
    :user:`jeff-hernandez`, :user:`frances-h`, :user:`gsheni`, :user:`rwedge`, :user:`thehomebrewnerd`
