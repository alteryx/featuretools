...
Featuretools is available for Python 3.8 and 3.9. It can be installed from PyPi, conda-forge, or from source.
...
Featuretools allows users to install add-ons. Featuretools allows users to install add-ons individually or all at once:
...
To install Woodwork from source, clone the repository from [Github](https://github.com/alteryx/featuretools), and install the dependencies.
